...
func scanTreeWithSetup(t *testing.T, folderName string, directoryType DirectoryType, files map[string]string, setup func(itemPath string)) *ScanResult {
	t.Helper()
...
func TestSidecarStatRecordsPermissionsAndOwnership(t *testing.T) {
	...
	result := scanTreeWithSetup(t, "The Movie (2019)", TypeMovie, map[string]string{
...
func TestMediaFileStatRecorded(t *testing.T) {
	...
	result := scanTreeWithSetup(t, "The Show", TypeTV, map[string]string{
