...
// hands it to the ConfigPropagator, which persists it, swaps the in-memory
...
// logged and skipped.
//
// This path still backs the config services not yet reshaped to AIP
// synchronous writes (docs/adr/0002); event_bus and logging now persist and
// propagate synchronously through appconfigstore.Store.MutateSync and never
// reach here.
//
