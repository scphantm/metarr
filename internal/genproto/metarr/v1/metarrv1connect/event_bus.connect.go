...
type EventBusServiceClient interface {
	...
	UpdateEventBusConfig(context.Context, *connect.Request[v1.UpdateEventBusConfigRequest]) (*connect.Response[v1.EventBusConfig], error)
}
...
func NewEventBusServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventBusServiceClient {
	...
	return &eventBusServiceClient{
		...
		updateEventBusConfig: connect.NewClient[v1.UpdateEventBusConfigRequest, v1.EventBusConfig](
			httpClient,
...
type eventBusServiceClient struct {
	...
	updateEventBusConfig *connect.Client[v1.UpdateEventBusConfigRequest, v1.EventBusConfig]
}
...
func (c *eventBusServiceClient) UpdateEventBusConfig(ctx context.Context, req *connect.Request[v1.UpdateEventBusConfigRequest]) (*connect.Response[v1.EventBusConfig], error) {
...
func (UnimplementedEventBusServiceHandler) UpdateEventBusConfig(context.Context, *connect.Request[v1.UpdateEventBusConfigRequest]) (*connect.Response[v1.EventBusConfig], error) {
