...
const file_metarr_v1_event_bus_proto_rawDesc = "" +
	"\n" +
	"\x19metarr/v1/event_bus.proto\x12\tmetarr.v1\x1a google/protobuf/field_mask.proto\"\x8e\x02\n" +
	...
	"\x14retry_backoff_max_ms\x18\x06 \x01(\x05R\x11retryBackoffMaxMsJ\x04\b\x02\x10\x03J\x04\b\a\x10\bR\fmax_len_highR\x0fmax_len_defaultR\x04etag\"\x1a\n" +
	...
	"\x11GetEventBusConfig\x12#.metarr.v1.GetEventBusConfigRequest\x1a$.metarr.v1.GetEventBusConfigResponse\x12Y\n" +
	"\x14UpdateEventBusConfig\x12&.metarr.v1.UpdateEventBusConfigRequest\x1a\x19.metarr.v1.EventBusConfigB-Z+Metarr/internal/genproto/metarr/v1;metarrv1b\x06proto3"
...
var file_metarr_v1_event_bus_proto_depIdxs = []int32{
	...
	0, // 6: metarr.v1.EventBusService.UpdateEventBusConfig:output_type -> metarr.v1.EventBusConfig
