...
// videos at all.
var extraTypeToSidecarType = map[string]scanmodel.SidecarType{
	ExtraTrailer:         scanmodel.SidecarTrailer,
	ExtraBehindTheScenes: scanmodel.SidecarBehindTheScenes,
	ExtraDeletedScene:    scanmodel.SidecarDeletedScene,
	ExtraInterview:       scanmodel.SidecarInterview,
	ExtraScene:           scanmodel.SidecarScene,
	ExtraShort:           scanmodel.SidecarShort,
	ExtraFeaturette:      scanmodel.SidecarFeaturette,
	ExtraSample:          scanmodel.SidecarOtherExtra,
	ExtraClip:            scanmodel.SidecarOtherExtra,
	ExtraOther:           scanmodel.SidecarOtherExtra,
	ExtraExtra:           scanmodel.SidecarOtherExtra,
	ExtraThemeMusic:      scanmodel.SidecarTheme,
	ExtraBackdrop:        scanmodel.SidecarFanart,
}
